    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('cliente', 'Cliente'), ('trabajador', 'Trabajador'), ('admin', 'Administrador')], default='cliente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_estadía', models.DecimalField(decimal_places=2, max_digits=10)),
